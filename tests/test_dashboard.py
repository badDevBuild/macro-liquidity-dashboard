...
class FrontendDeploymentTests(unittest.TestCase):
    ...
    def test_frontend_theme_switch_follows_system_and_persists_user_choice(self) -> None:
        ...
        self.assertIn('assets/app.css?v=47', index)
        self.assertIn('assets/app.js?v=47', index)
        self.assertIn('assets/coinbase-premium.js?v=47', index)
        self.assertIn('assets/coinbase-premium.js?v=47', service_worker)
        self.assertIn('`${CACHE_PREFIX}shell-v47`', service_worker)
